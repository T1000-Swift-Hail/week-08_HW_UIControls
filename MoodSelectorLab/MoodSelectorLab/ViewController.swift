...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Do any additional setup after loading the view.
            labelView.text = imageAh[Views.selectedMoodIndex].description
            imageView.image = UIImage(named: imageAh[Views.selectedMoodIndex].imageName)
          }
          // “When CR7 lose the match he is sad “, imageName: “crSad.jpeg”)
    let imageAh = [MoodPage(description: "keep smiling", imageName: "happy"), MoodPage(description: "Life does not stand on anyone, make your order to God", imageName: "sad") , MoodPage(description: "Get out of the place", imageName: "angry"), MoodPage(description: "live your life", imageName: "sleep")
