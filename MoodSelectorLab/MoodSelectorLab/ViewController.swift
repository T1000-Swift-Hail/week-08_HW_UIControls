...
class ViewController: UIViewController {
    ...
    let moodArray = [ MoodPage(description: "Today I place a bubbles of happiness ", imageName: "happy1") , MoodPage(description: "Don't be sad! you are not alone..!", imageName: "sad1"),MoodPage(description: "Look to the sky,!", imageName: "angry1"), MoodPage(description: "Want me to till you a story? close your eyes..", imageName: "sleepy1")]
